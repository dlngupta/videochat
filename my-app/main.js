...
module.exports = "<h1>My id - {{mypeerid}}</h1>\nEnter PeerID:<input type=\"text\" [(ngModel)]=\"anotherid\"><br><br>\nEnter Message:<input type=\"text\" id=\"usrmsg\"><br><br>\n<button (click)=\"connect()\">SendMessage</button>\n<button (click)=\"videoconnect()\">VideoChat</button>\n<video #myvideo></video><br>\n<h1 id=\"msg\"></h1>\n<!-- <button (click)=\"endcall()\">EndCall</button> -->\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.connect = function () {
        ...
        conn.on('open', function () {
            // conn.send(usrmsg.value);
            conn.send('Welcome to PeerJs');
        });
    };
...
module.exports = __webpack_require__(/*! D:\LNGupta\PeerJs-Sample\Peer-JS Examples\angular-peerjs-5mbrn7\src\main.ts */"./src/main.ts");
